...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "La Buena Mesa",
    year: "2026",
    description: "Aplicación web gastronómica desarrollada con Django, Bootstrap y Python, con arquitectura profesional y templates reutilizables. Desplegado en Render.",
    ...
    title: "Gran Milla",
    year: "2026",
    description: "Simuladora de agencia de viajes argentino desarrollada con Python, Bootstrap y Django integrando sistema de gestión, panel de administración, formulario y Mercado Pago. Desplegado con Render.",
    tags: ["Bootstrap", "Python", "Django", "UX/UI", "Render"],
    demo: "https://granmilla.onrender.com",
  },
  {
    slug: "coming-soon",
    title: "PRÓXIMAMENTE",
