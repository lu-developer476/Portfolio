...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Tick Tack Toe",
    year: "2026",
    description: "Tres en Raya web desarrollado con Python y Django. Desplegado en Render.",
  ...
  },
  {
    ...
    title: "Minesweeper",
    year: "2026",
    description: "Buscaminas web construido con Python y Django. Desplegado en Render.",
    tags: ["CSS", "JavaScript", "Python", "Django", "FastAPI", "UX/UI", "Render"],
