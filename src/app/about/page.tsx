        ...
        <div className="w-full max-w-full overflow-hidden rounded-xl border border-white/10 bg-black/35 p-4 sm:p-5 md:p-6 space-y-4 text-white/85 leading-7">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              <CSS3Icon className="w-10 h-10 word delay-0" />
              <CoffeeScriptIcon className="w-10 h-10 word delay-1" />
              <HTML5Icon className="w-10 h-10 word delay-2" />
              <JavaScriptIcon className="w-10 h-10 word delay-3" />
              <PythonIcon className="w-10 h-10 word delay-4" />
              <TypeScriptIcon className="w-10 h-10 word delay-5" />
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              <BootstrapIcon className="w-10 h-10 word delay-6" />
              <DjangoIcon className="w-10 h-10 word delay-7" />
              <NextJSIcon className="w-10 h-10 word delay-8" />
              <ReactIcon className="w-10 h-10 word delay-9" />
              <TailwindIcon className="w-10 h-10 word delay-10" />
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              <FirebaseIcon className="w-10 h-10 word delay-13" />
              <GitHubIcon className="w-10 h-10 word delay-14" />
              <N8nIcon className="w-10 h-10 word delay-15" />
              <OpenAIIcon className="w-10 h-10 word delay-16" />
              <GeminiIcon className="w-10 h-10 word delay-17" />
            </div>
          </div>
